  ...
  window.addEventListener('scroll', () => {
    if (!ticking) {
      requestAnimationFrame(() => {
        ...
        if (scrolled) {
          header.style.background = 'linear-gradient(135deg, rgba(0,212,255,0.95), rgba(0,153,204,0.95))';
          header.style.backdropFilter = 'blur(20px)';
        } else {
          header.style.background = 'linear-gradient(135deg, #00d4ff 0%, #0099cc 100%)';
